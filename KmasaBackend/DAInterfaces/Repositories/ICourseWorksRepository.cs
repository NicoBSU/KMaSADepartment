...
public interface ICourseWorksRepository
{
    ...
    Task<PagedModel<GetCourseWorkDto>> GetAsync(int page, int limit);
    ...
    /// <returns>Paged model with collection of blog articles.</returns>
    Task<PagedModel<GetCourseWorkDto>> GetByMentorAsync(int mentorId, int page, int limit);
    ...
    /// <returns>Paged model with collection of blog articles.</returns>
    Task<PagedModel<GetCourseWorkDto>> GetByTitleAsync(string title, int page, int limit);
    ...
    /// <returns>Paged model with collection of blog articles.</returns>
    Task<PagedModel<GetCourseWorkDto>> GetByStatusAsync(CourseWorkStatus status, int page, int limit);
    ...
    Task<GetCourseWorkDto> GetByIdAsync(int id);
    ...
    Task<int> AddAsync(AddCourseWorkDto courseWorkDto);
    ...
    Task<bool> UpdateAsync(int courseWorkId, AddCourseWorkDto courseWorkDto);
